...
type Repository interface {
	...
	GetGenderProductAffinitiesByGender(ctx context.Context, gender float32, threshold float32, options GetGenderProductAffinitiesByGenderOptions) (gPAffinities []gPAModel.GenderProductAffinityWithScore, err error)
}
